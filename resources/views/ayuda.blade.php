...
<div class="container mx-auto px-4 sm:px-8 w-11/12 sombra1" style="padding: 1rem; margin-top: 3rem;">
    ...
    <div class="main-title my-8">
        <h1 class="font-bold text-2xl text-center">¿Cómo podemos ayudarte?</h1>
    </div>
    ...
    <div class="main-question mb-8 flex flex-col divide-y text-gray-800 text-base">
        <div class="item px-6 py-6" x-data="{isOpen : false}">
            ...
            <div style="font-size: small ;" x-show="isOpen" @click.away="isOpen = false" class="mt-3" :class="{'text-black-600' : isOpen == true}">
                ...
                <div style="display: flex; align-items: center; ">
                    ...
                    <p style="margin-left: 4.4rem;">Icono Ayuda: Este icono nos servira para redireccionarnos a esta página.</p>
                </div>
                <div style="display: flex; align-items: center; ">
                    <img style="height: 48px;  width: 40px;" src="{{Storage::url(auth()->user()->image)}}" alt="">
                    <p style="margin-left: 4.4rem;">Icono Usuario: Este icono despliega la opcion de perfil y cerrar sesión.</p>
                </div>
                <div style="display: flex; justify-content: center;">
                ...
                <div style="display: flex; margin-top: 2rem; align-items: center; ">
                    <div style="display: flex; align-items: center;">
                        ...
                        <p style="margin-left: 2rem;">Aside colapsado: Este mostrará la imagen de la clase,
                            puedes dar click en ellas e ir hacia esa clase.</p>
                    </div>
                    <div style="display: flex; align-items: center;">
                        <img style="height: 266px;" src="{{asset('img/aside-abierto.jpg')}}" alt="">
                        <p style="margin-left: 2rem;">Aside abierto: Este mostrará la imagen, nombre y nrc de la clase,
                            puedes dar click en ellas e ir hacia ellas mismas.</p>
                    </div>
                </div>
        ...
        <div class="item px-6 py-6" x-data="{isOpen : false}">
            <a href="#" class="flex items-center justify-between" @click.prevent="isOpen = true">
                <h4 style="font-weight: 900;" :class="{'text-blue-600 font-bold' : isOpen == true}">- ¿Dónde puedo entrar a mi clase en vivo?</h4>
                <svg class="w-5 h-5 text-black-500" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                    <path d="M19 9l-7 7-7-7"></path>
                </svg>
            </a>
            <div style="font-size: 15px ;" x-show="isOpen" @click.away="isOpen = false" class="mt-3" :class="{'text-black-600' : isOpen == true}">
                <div style="display: flex; align-items: center;">
                    ...
                    <p style="margin-left: 2rem;">Para ir a una clase en vivo, basta con seleccionar cualquier clase y presionar en la pestaña streaming
                        en el menú de navegación. Para que una clase inicié, el maestro deberá introducir las credenciales de host.</p>
                </div>
            </div>
        </div>
        ...
        <div class="item px-6 py-6" x-data="{isOpen : false}">
            <a href="#" class="flex items-center justify-between" @click.prevent="isOpen = true">
                <h4 style="font-weight: 900;" :class="{'text-blue-600 font-bold' : isOpen == true}">- ¿Cómo ver videos de  las clases grabadas?</h4>
                <svg class="w-5 h-5 text-black-500" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                    <path d="M19 9l-7 7-7-7"></path>
                </svg>
            </a>
            ...
            <div style="display: flex; align-items: center;">
                ...
                la opción videos, que se encuentra en el menú de navegación, a continuación da click sobre el video que deseas ver.</p>
                </div>
            </div>
        </div>
