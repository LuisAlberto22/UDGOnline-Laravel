<div>
    ...
    <div class="heading text-center font-bold text-2xl m-5 text-gray-100">Videos de la clase</div>
    ...
    <div class="holder mx-auto w-10/12 grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4">
        ...
        <div class="each mb-10 m-2 shadow-lg border-gray-800 bg-gray-100 relative">
            ...
            <div class="desc p-4 text-gray-800">
                <a href="https://www.youtube.com/watch?v=dvqT-E74Qlo" target="_new"
                    class="title font-bold block cursor-pointer hover:underline">Pubg Mobile Custom Room (Unlimited)</a>
                <a href="https://www.youtube.com/user/sam14319" target="_new"
                    class="badge bg-indigo-500 text-blue-100 rounded px-1 text-xs font-bold cursor-pointer">@dynamo_gaming</a>
                <span class="description text-sm block py-2 border-gray-400 mb-2">lorem ipsum bekhum bukhum !lorem ipsum
                    bekhum bukhum !</span>
            </div>
        </div>
        <!-- each -->
