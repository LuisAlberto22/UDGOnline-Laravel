        ...
        <div id="task-comments" class=" mx-8">
            <div class="bg-white rounded-lg p-3  flex flex-col justify-center items-center md:items-start shadow-lg mb-4">
                <div class=" flex flex-row justify-center mr-2">
                    <img alt="avatar" width="48" height="48" class="rounded-full w-10 h-10 mr-4 shadow-lg mb-4" src="{{Storage::url($img)}}">
                    <p style="width: 90%" class="text-gray-600 text-lg text-center md:text-left "><span class="text-purple-600 font-semibold">{{$user}}</span></p>              
                </div>
                <h3 class="text-purple-600 font-semibold text-lg text-center md:text-left ">{{$title}}</h3>
                <h2 class="text-purple-600 font-semibold text-lg text-center md:text-left ">{{$description}}</h2>
                <img src="" alt="">
                <p style="width: 90%" class="text-gray-600 text-lg text-center md:text-left "><span class="text-purple-600 font-semibold"></span> {{$date}} </p>
