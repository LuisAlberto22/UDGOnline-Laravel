...
@section('content')
@section('url','https://web.udgonline.com/clases/'.$lesson->nrc.'/tareas/'.$homework->slug.'/alumnos/'.$user->key)
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td align="center"
                                                    ...
                                                    <h1
                                                        ...
                                                        <em>Se ha entregado una tarea</em>
                                                    </h1>
                                                </td>
                                            </tr>
                                            <tr style="border-collapse:collapse">
                                                <td align="center"
                                                    ...
                                                    <h4
                                                        ...
                                                        Fecha: </h4>
                                                        <p>{{date('d/m/Y h:i A',strtotime($homework->pivot->updated_at))}} </p>
                                                </td>
                                            </tr>
                                            <tr style="border-collapse:collapse">
