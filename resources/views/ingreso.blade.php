...
<body>
			...
			<form action="{{route('login')}}" method="POST" id="Form" class="Form-Inicio">
				...
				<div class="contenedor sombra">
					<fieldset>
						...
						<div>
							<div onclick="javscript:" style="display: none;" id="Error-Usuario-Contraseña" class="Mensaje-Usuario-Contraseña">
							...
							@error('Codigo')
							<div style="color: rgb(94, 21, 21); " class="Mensaje-Usuario-Contraseña">
	...
	<footer style="position: absolute;" class="Footer-principal">
...
<!--<script type="text/javascript">
	...
	url: "lib/login.php",method: "POST",data: {Codigo: d.get("Codigo"),NIP: d.get("NIP"),recordar: d.get("recordar"),src: d.get("src")},processData: true,}).done(function(response) { alert(response); document.getElementById("Carga").hidden = true;if (response != false) {location.href = `${response}`;}else{$("#Error-Usuario-Contraseña").fadeIn();}});
